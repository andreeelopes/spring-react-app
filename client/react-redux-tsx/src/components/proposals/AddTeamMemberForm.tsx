                ...
                <Modal show={this.props.teamMemberModal} onHide={this.handleClose}>
                    ...
                    <Modal.Body>
                        <FormControl
                            ...
                            inputRef={(ref) => {this.newTeamMember = ref}}
                        />
                    </Modal.Body>
...
export default connect(mapStateToProps, {showTeamMemberModal,submitTeamMember,changeTitle,submitStaffMember})(AddTeamMemberForm);